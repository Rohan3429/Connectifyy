...
import styles from './InternalMarks.module.css';


const InternalMarks = () => {
  	return (
    		<div className={styles.internalMarks}>
      			<img className={styles.icon} alt="" src="05 1.png" />
      			<div className={styles.internalMarksChild} />
      			<div className={styles.internalMarksItem} />
      			<div className={styles.internalMarksInner} />
              							...
              							<div className={styles.instanceWrapper}>
                								<div className={styles.frameParent3}>
                  									<div className={styles.ellipseGroup}>
                    										<img className={styles.frameItem} alt="" src="Ellipse 2.png" />
                    										<div className={styles.nehaPathakParent}>
      			...
      			<div className={styles.internalMarksChild1} />
      			<div className={styles.homeParent}>
        				<img className={styles.campaignIcon} alt="" src="home.svg" />
        				<div className={styles.internalMarksParent}>
          					<b className={styles.internalMarks1}>Internal Marks</b>
          					<div className={styles.goodToBe}>Good to be updated about your academics!</div>
        				</div>
      			...
      			<div className={styles.cardheaderParent}>
          					...
          					<div className={styles.stackWrapper}>
            						<div className={styles.stack}>
              							...
              							<div className={styles.text}>
                								<div className={styles.evanTony}>CD</div>
        				...
        				<div className={styles.frameParent17}>
          					<div className={styles.frameParent18}>
            						<div className={styles.outOf20Wrapper}>
              							<div className={styles.announcement}>Out of 20</div>
            						</div>
          					...
          					<div className={styles.frameParent18}>
            						<div className={styles.outOf20Wrapper}>
              							<div className={styles.announcement}>Internal Exam</div>
            						</div>
            						<div className={styles.wrapper}>
              							<div className={styles.div1}>10</div>
            						</div>
        				...
        				<div className={styles.cardheader}>
          					<div className={styles.stackWrapper}>
            						<div className={styles.stack}>
              							<div className={styles.avatar} />
              							<div className={styles.text}>
                								<div className={styles.evanTony}>BDA</div>
                								<div className={styles.subtitle}>subheader</div>
              							</div>
            						</div>
          					</div>
        				...
        				<div className={styles.cardheader}>
          					<div className={styles.stackWrapper}>
            						<div className={styles.stack}>
              							<div className={styles.avatar} />
              							<div className={styles.text}>
                								<div className={styles.evanTony}>SEO</div>
                								<div className={styles.subtitle}>subheader</div>
              							</div>
            						</div>
          					</div>
        				...
        				<div className={styles.cardheader}>
          					<div className={styles.stackWrapper}>
            						<div className={styles.stack}>
              							<div className={styles.avatar} />
              							<div className={styles.text}>
                								<div className={styles.evanTony}>CP - III</div>
                								<div className={styles.subtitle}>subheader</div>
              							</div>
            						</div>
          					</div>
      			...
      			<div className={styles.cardheaderParent2}>
        				<div className={styles.cardheader}>
          					<div className={styles.stackWrapper}>
            						<div className={styles.stack}>
              							<div className={styles.avatar} />
              							<div className={styles.text}>
                								<div className={styles.evanTony}>FCL</div>
                								<div className={styles.subtitle}>subheader</div>
              							</div>
            						</div>
          					</div>
      			...
      			<div className={styles.youCanCheck}>You can check your marks here after declaration fo every exam</div>
    		</div>);
};
