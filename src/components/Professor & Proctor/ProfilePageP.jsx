import styles from './ProfilePageP.module.css';
...
const ProfilePageP = () => {
    return (
        <div className={styles.profilePage}>
            ...
            <div className={styles.frameContainer}>
                <div className={styles.frameDiv}>
                    <div className={styles.ellipseParent}>
                        ...
                        <div className={styles.rotterMullerParent}>
                            <div className={styles.rotterMuller}>Rotter Muller</div>
                            <div className={styles.professorBwt}>Professor, BWT</div>
                        </div>
                    </div>
            ...
            <div className={styles.profilePageInner1}>
                <div className={styles.homeParent}>
                    ...
                    <div className={styles.frameWrapper}>
                        <div className={styles.evansProfileParent}>
                            <div className={styles.evansProfile}>Evan’s Profile</div>
            ...
            <div className={styles.frameParent1}>
                ...
                <div className={styles.frameParent2}>
                    <div className={styles.evanTonyParent}>
                        <b className={styles.evanTony}>Evan Tony</b>
                        <div className={styles.frameParent3}>
                            <div className={styles.assignRoleWrapper}>
                                <div className={styles.assignRole}>Assign Role</div>
                            </div>
                            <div className={styles.assignRoleWrapper}>
                                <div className={styles.assignRole}>Edit</div>
                            </div>
                        </div>
                    </div>
            ...
            <div className={styles.userprofilesocialcard}>
                ...
                <div className={styles.stack13}>
                    ...
                    <div className={styles.item1}>
                                <img className={styles.campaignIcon} alt="" src="\src\components\img\location.png" />
                        
                        <div className={styles.wed}>Junagadh, Gujarat, India</div>
                    </div>
                    <div className={styles.item1}>
                                <img className={styles.campaignIcon} alt="" src="\src\components\img\work.png" />
                ...
                <div className={styles.cardheader}>
                    <div className={styles.stackParent}>
                        <div className={styles.stack21}>
                            <div className={styles.avatar} />
                            <div className={styles.text}>
                                <div className={styles.title}>Internal Marks</div>
                                <div className={styles.subtitle}>subheader</div>
                            </div>
                        </div>
            ...
            <div className={styles.addRemarks}>// Add remarks...</div>
        </div>);
};
